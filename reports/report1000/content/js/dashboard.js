...
$(document).ready(function() {
    ...
    // Creates APDEX table
    createTable($("#apdexTable"), {"supportsControllersDiscrimination": true, "overall": {"data": [0.8135, 500, 1500, "Total"], "isController": false}, "titles": ["Apdex", "T (Toleration threshold)", "F (Frustration threshold)", "Label"], "items": [{"data": [0.8135, 500, 1500, "HTTP Request"], "isController": false}]}, function(index, item){
        switch(index){
            case 0:
                item = item.toFixed(3);
                break;
    ...
    createTable($("#statisticsTable"), {"supportsControllersDiscrimination": true, "overall": {"data": ["Total", 1000, 1, 0.1, 546.3220000000003, 116, 3636, 158.0, 1378.1999999999996, 2296.049999999999, 3084.8100000000004, 44.81692287007574, 50.205632646887466, 11.510596401201093], "isController": false}, "titles": ["Label", "#Samples", "FAIL", "Error %", "Average", "Min", "Max", "Median", "90th pct", "95th pct", "99th pct", "Transactions/s", "Received", "Sent"], "items": [{"data": ["HTTP Request", 1000, 1, 0.1, 546.3220000000003, 116, 3636, 158.0, 1378.1999999999996, 2296.049999999999, 3084.8100000000004, 44.81692287007574, 50.205632646887466, 11.510596401201093], "isController": false}]}, function(index, item){
        switch(index){
            // Errors pct
            case 3:
                item = item.toFixed(2) + '%';
